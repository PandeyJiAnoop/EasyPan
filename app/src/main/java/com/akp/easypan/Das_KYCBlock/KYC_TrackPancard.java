...
public class KYC_TrackPancard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_k_y_c__track_pancard);
        ...
        pd = new ProgressDialog(KYC_TrackPancard.this);
        ...
        if (wifi.isConnected())
        {
            ...
            mWebView.setWebViewClient(new KYC_TrackPancard.MyWebViewClient());


            mWebView.loadUrl("https://tin.tin.nsdl.com/pantan/StatusTrack.html");
        }
