...
public class KYC_ApplyNSDLForm extends AppCompatActivity {
    ...
    EditText et_dob,f_name_et,m_name_et,l_name_et,father_fname,father_m_name_et,father_l_name_et,mob_et,email_et,
            ...
            city_et,area_code_et,ao_type_et,range_code_et,ao_number_et;
    private String UserId,checksum;

    EditText rep_f_name_et,rep_m_name_et,rep_l_name_et,rep_pincode,rep_state,rep_flatdoor,rep_building_vill,rep_roadpostoffice,rep_taluka,rep_citydistrict;

    LinearLayout minor_ll;
    String colors1[] = {"Mr","Mrs"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_k_y_c__apply_n_s_d_l_form);
        ...
        spinnerArrayAdapter1 = new ArrayAdapter<>(this,
                android.R.layout.simple_spinner_dropdown_item, colors1);
...
//                Toast.makeText(Oder_Summery_Details.this, imc_met + " selected size", Toast.LENGTH_LONG).show();
        ...
        cat_spinner.setTitle("");
        gender_sp.setTitle("");
        address_proof_sp.setTitle("");
        dob_proof_sp.setTitle("");
        identity_sp.setTitle("");
        cat_formtype.setTitle("");
        sp.setTitle("");
        stateet.setTitle("");
    ...
    private void findID() {
        ...
        minor_ll=findViewById(R.id.minor_ll);
        rep_f_name_et=findViewById(R.id.rep_f_name_et);
        rep_m_name_et=findViewById(R.id.rep_m_name_et);
        rep_l_name_et=findViewById(R.id.rep_l_name_et);
        rep_pincode=findViewById(R.id.rep_pincode);
        rep_state=findViewById(R.id.rep_state);
        rep_flatdoor=findViewById(R.id.rep_flatdoor);
        rep_building_vill=findViewById(R.id.rep_building_vill);
        rep_roadpostoffice=findViewById(R.id.rep_roadpostoffice);
        rep_taluka=findViewById(R.id.rep_taluka);
        rep_citydistrict=findViewById(R.id.rep_citydistrict);
            ...
            public void onClick(View v) {
                ...
                if (et_dob.getText().toString().equalsIgnoreCase("")){
                    ...
                    if (cat_spinner.getSelectedItem().toString().equalsIgnoreCase("Select Category")){
                       ...
                       if (cat_formtype.getSelectedItem().toString().equalsIgnoreCase("Minor")){
                           NsdlPanApply(UserId,"1","NEW PAN",catid,genderid,et_dob.getText().toString(),f_name_et.getText().toString(),
                                   ...
                                   "0",formtypeid,sp.getSelectedItem().toString(),rep_f_name_et.getText().toString(),rep_m_name_et.getText().toString(),
                                   rep_l_name_et.getText().toString(),rep_pincode.getText().toString(),rep_state.getText().toString(),rep_flatdoor.getText().toString(),rep_building_vill.getText().toString(),
                                   rep_roadpostoffice.getText().toString(),rep_taluka.getText().toString(),city_et.getText().toString(),
                                   checksum);
                       }
                       else {
                           NsdlPanApply(UserId,"1","NEW PAN",catid,genderid,et_dob.getText().toString(),f_name_et.getText().toString(),
        ...
        et_dob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        ...
                        KYC_ApplyNSDLForm.this,  R.style.MyTimePickerDialogTheme,
                ...
                if (position > 0) {
                    for (int j = 0; j <= FormTypeId.size(); j++) {
                        if (cat_formtype.getSelectedItem().toString().equalsIgnoreCase(FormTypeName.get(j))) {
                            if (cat_formtype.getSelectedItem().toString().equalsIgnoreCase("Minor")){
                                minor_ll.setVisibility(View.VISIBLE);
                            }
                            else {
                                minor_ll.setVisibility(View.GONE);
                            }
                            // position = i;
            ...
            public void RetrofitCallBackListenar(String result, String action) throws JSONException {
                ...
                try {
                    ...
                    if (object.getString("status").equalsIgnoreCase("0")){
                        ...
                        cat_spinner.setAdapter(new ArrayAdapter<String>(KYC_ApplyNSDLForm.this, android.R.layout.simple_spinner_dropdown_item, CatName));
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
        }, KYC_ApplyNSDLForm.this, call1, "", true);
    }
            ...
            public void RetrofitCallBackListenar(String result, String action) throws JSONException {
                ...
                try {
                    ...
                    if (object.getString("status").equalsIgnoreCase("0")){
                        ...
                        address_proof_sp.setAdapter(new ArrayAdapter<String>(KYC_ApplyNSDLForm.this, android.R.layout.simple_spinner_dropdown_item, AddressName));
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            ...
            public void RetrofitCallBackListenar(String result, String action) throws JSONException {
                ...
                try {
                    ...
                    if (object.getString("status").equalsIgnoreCase("0")){
                        ...
                        identity_sp.setAdapter(new ArrayAdapter<String>(KYC_ApplyNSDLForm.this, android.R.layout.simple_spinner_dropdown_item, IdentityName));
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            ...
            public void RetrofitCallBackListenar(String result, String action) throws JSONException {
                ...
                try {
                    ...
                    if (object.getString("status").equalsIgnoreCase("0")){
                        ...
                        dob_proof_sp.setAdapter(new ArrayAdapter<String>(KYC_ApplyNSDLForm.this, android.R.layout.simple_spinner_dropdown_item, DOBName));
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            ...
            public void RetrofitCallBackListenar(String result, String action) throws JSONException {
                ...
                try {
                    ...
                    if (object.getString("status").equalsIgnoreCase("0")){
                        ...
                        gender_sp.setAdapter(new ArrayAdapter<String>(KYC_ApplyNSDLForm.this, android.R.layout.simple_spinner_dropdown_item, GenderName));
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            ...
            public void RetrofitCallBackListenar(String result, String action) throws JSONException {
                ...
                try {
                    ...
                    if (object.getString("status").equalsIgnoreCase("0")){
                        ...
                        cat_formtype.setAdapter(new ArrayAdapter<String>(KYC_ApplyNSDLForm.this, android.R.layout.simple_spinner_dropdown_item, FormTypeName));
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                } }}, KYC_ApplyNSDLForm.this, call1, "", true);
    ...
    public void NsdlPanApply(String user_id,String status,String pan,String category,String gender,
        ...
        String otp1 = new GlobalAppApis().GetnsdlPanApply(user_id,status,pan,category,gender,dob,fname,mname,lname,ffname,fmname,flname,
        ...
        Log.d("GetnsdlPanApply","cxc"+otp1);
        ApiService client1 = getApiClient_ByPost();
        Call<String> call1 = client1.API_nsdlPanApply(otp1);
        new ConnectToRetrofit(new RetrofitCallBackListenar() {
            @Override
            public void RetrofitCallBackListenar(String result, String action) throws JSONException {
                Log.d("resupdatensdl","cxc"+result);
                try {
                    JSONObject object = new JSONObject(result);
                    if (object.getString("status").equalsIgnoreCase("0")){
                        String msg       = object.getString("message");
                        Toast.makeText(getApplicationContext(), object.getString("message"), Toast.LENGTH_LONG).show();
                        androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(KYC_ApplyNSDLForm.this).setTitle("Response:-")
                        ...
                        androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(KYC_ApplyNSDLForm.this).setTitle("Error Response:-")
...
//                            ProductSizeValue.add(productSizeValue);
                        ...
                        stateet.setAdapter(new ArrayAdapter<String>(KYC_ApplyNSDLForm.this, android.R.layout.simple_spinner_dropdown_item, ProductSizeValue));
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
