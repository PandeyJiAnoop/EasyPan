...
public class Web_BillReciepet extends AppCompatActivity {
    ...
    String UserId,Getrecipturl;
    RelativeLayout header;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_web_bill_reciepet);
        SharedPreferences sharedPreferences = getSharedPreferences("login_preference",MODE_PRIVATE);
        UserId= sharedPreferences.getString("U_id", "");
        Getrecipturl=getIntent().getStringExtra("recipturl");
        ...
        if (wifi.isConnected())
        {
            ...
            mWebView.setWebChromeClient(new WebChromeClient() {
                ...
                public boolean onShowFileChooser(
                    ...
                    if (takePictureIntent.resolveActivity(Web_BillReciepet.this.getPackageManager()) != null) {
