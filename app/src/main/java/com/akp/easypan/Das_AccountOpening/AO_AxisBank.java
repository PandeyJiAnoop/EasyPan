package com.akp.easypan.Das_AccountOpening;
...
public class AO_AxisBank extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Gett_name=getIntent().getStringExtra("t_name");
        RelativeLayout header=findViewById(R.id.header);
        TextView titke_tv=findViewById(R.id.titke_tv);
        titke_tv.setText(Gett_name);
