        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (otp.length() != 6) {
                    ...
                    OtpverifyAPI(Userid,otp,checksum);
...
//        Toast.makeText(getApplicationContext(),Get_OTP,Toast.LENGTH_LONG).show();
    ...
    public void OtpverifyAPI(String user_id, String otp,String checksum) {
        String otp1 = new GlobalAppApis().VerifyOtp(user_id,otp,checksum);
            ...
            public void RetrofitCallBackListenar(String result, String action) throws JSONException {
                ...
                try {
                    ...
                    if (object.getString("status").equalsIgnoreCase("0")){
                        ...
                        if (object.getString("fullname").equalsIgnoreCase("")){
